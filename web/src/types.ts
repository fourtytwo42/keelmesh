...
export type ConstraintSetV2 = { minimum_reserve:number; maximum_speed_mps:number; minimum_vessel_separation_m:number; minimum_object_separation_m:number; maximum_wave_height_m:number; maximum_wind_mps:number; maximum_pnt_uncertainty_m:number; maximum_duration_minutes:number; maximum_route_distance_km:number; minimum_tape_watermark_seconds:number; formation:string; formation_spacing_m:number; leader_policy:string; regroup_threshold_m:number };
