...
export type StreamMessage = { schema_version: number; sequence: number; kind: string; snapshot?: FleetSnapshot; audit?: AuditEvent; resilience?: ResilienceSnapshot; platform?: PlatformSnapshot };
