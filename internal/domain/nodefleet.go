...
func VMFleetSpecs() []NodeFleetSpec {
	return []NodeFleetSpec{
		...
		{"node-a-03", "vm-vessel-222", "A", 222, "192.168.50.222", "mini42", "Tern", 2, GeoPointV2{-71.30, 41.10}, 48},
		{"node-a-04", "vm-vessel-223", "A", 223, "192.168.50.223", "mini43", "Petrel", 3, GeoPointV2{-71.20, 41.10}, 315},
		{"node-a-05", "vm-vessel-224", "A", 224, "192.168.50.224", "mini43", "Shearwater", 4, GeoPointV2{-71.10, 41.10}, 258},
		{"node-a-06", "vm-vessel-225", "A", 225, "192.168.50.225", "mini42", "Cormorant", 5, GeoPointV2{-71.45, 41.20}, 122},
		{"node-b-01", "vm-vessel-229", "B", 229, "192.168.50.229", "fourtyfour", "Harrier", 0, GeoPointV2{-71.35, 41.20}, 80},
		...
		{"node-b-04", "vm-vessel-233", "B", 233, "192.168.50.233", "fourtyfour", "Plover", 3, GeoPointV2{-71.42, 41.30}, 146},
