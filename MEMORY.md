...
- Last meaningful change: VM 214 and all twelve vessel nodes run the verified M11 memory protocol; central and node-local restart continuity, scene restoration, hybrid/keyword retrieval, Kafka replay, private MCP scope enforcement, and the optional memory lab are live.
