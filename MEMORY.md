...
- Current task: responsive desktop/tablet/phone and touch-input support is implemented, verified, and deployed.
- Last meaningful change: the graphite/amber workspace now adapts windows, navigation, status bars, map menus, mission authoring, and control sizing across phone, tablet, and desktop. Touch/pen long press invokes the same bounded menus as right-click; keyboard Context Menu/Shift+F10 support and visible focus states remain available.
