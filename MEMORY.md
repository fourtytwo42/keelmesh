...
- Last meaningful change: underway propulsion now always consumes stored battery according to class load, speed cubed, and simulated travel time; daylight solar extends range but cannot pin moving vessels at 100%. Stationary vessels still recharge from the full daylight array, and the UI exposes sub-percent reserve changes.
