...
- Last meaningful change: routine AI mission requests now produce one exact validated recommendation without opening Mission; alternatives appear only when explicitly requested. The assistant can manage missions and groups through typed actions, and moving-contact plans steer every assigned vessel toward one shared predicted intercept point.
