...
- Current task: vessel inspection framing and authoritative game-time clock are complete.
- Last meaningful change: Fleet eye actions open the vessel inspector and issue a one-shot camera frame; the lower clock now displays simulation day/time from the authoritative fleet tick and follows pause/acceleration.
